...
This project is indexed by GitNexus as **TextMgmt** (5716 symbols, 8667 relationships, 88 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
