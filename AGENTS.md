...
This project is indexed by GitNexus as **TextMgmt** (6014 symbols, 9117 relationships, 89 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
