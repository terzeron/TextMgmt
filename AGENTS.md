...
This project is indexed by GitNexus as **TextMgmt** (5622 symbols, 8484 relationships, 89 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
