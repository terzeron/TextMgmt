...
This project is indexed by GitNexus as **TextMgmt** (6315 symbols, 17099 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
