...
This project is indexed by GitNexus as **TextMgmt** (5853 symbols, 15925 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
