...
This project is indexed by GitNexus as **TextMgmt** (4180 symbols, 11899 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
